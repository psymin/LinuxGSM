...
fn_monitor_query(){
	...
	local allowed_engines_array=( avalanche2.0 avalanche3.0 barotrauma goldsource idtech2 idtech3 idtech3_ql ioquake3 iw2.0 iw3.0 lwjgl2 madness quake refractor realvirtuality source spark starbound qfusion unity3d unreal unreal2 unreal4 wurm )
